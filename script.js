...
const caixasPerguntas=document.querySelector(".caixasperguntas");
const caixasAlternativas=document.querySelector(".caixasalternativas");
const caixaResultados=document.querySelector(".caixasresultados");
const textoResultados=document.querySelector(".textoresultado");
